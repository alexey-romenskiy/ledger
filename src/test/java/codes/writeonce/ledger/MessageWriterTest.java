...
public class MessageWriterTest {
    ...
    @Test
    public void chunk1() {
        messageWriter.sequence(1);
        messageWriter.chunk(true, false, 0, 26, SAMPLE);
        assertEquals(singletonList(new FullInvocation(1, 26, true,
    ...
    public void chunk2() {
        ...
        assertEquals(singletonList(new PartialInvocation(1, 3, true,
    ...
    public void chunk2b() {
        ...
        assertEquals(singletonList(new PartialInvocation(1, 4, true,
    ...
    public void chunk3() {
        ...
        assertEquals(singletonList(new FullInvocation(1, 9, true,
